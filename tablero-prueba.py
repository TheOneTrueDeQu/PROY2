...
def create_app():
    ...
    app.layout = html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col([
                html.H4("Distribución de ocupación, estado civil y educación"),
    ...
    # Callback único para actualizar los gráficos
    @app.callback(
    ...
    def update_graphs(selected_feature, __, segment):
        # Primer gráfico: Comparación entre clientes que compraron y no compraron, según la característica seleccionada
        ...
        # Segundo gráfico: Distribución de clientes por ocupación y estado civil
        fig_distribution = px.histogram(
            df, x="job", color="marital",
            title="Distribución de clientes por ocupación y estado civil",
            labels={'job': 'Ocupación', 'marital': 'Estado Civil'}
        )
        ...
        if segment:
            ...
            # Gráfico vacío si no se selecciona un segmento
            fig_segment = px.histogram(
